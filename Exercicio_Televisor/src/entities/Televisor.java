...
public class Televisor {
    ...
    public void mostraStatus(){
        if(ligado)
            System.out.println("Está no canal " + canal + ", no volume " + volume + " e o televisor esta " + ligadoT + ".");
        else
            System.out.println("Está no canal " + canal + ", no volume " + volume + " e o televisor esta " + desligadoT + ".");
    }
}
